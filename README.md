> <font face=楷体 size=4>各大平台搜集后，总结整理
## <font face=楷体>一、直方图均衡化
...
<font face=楷体 size=4>$$kg=Avg/avgG$$
 
<font face=楷体 size=4>$$kb=Avg/avgB$$
...
<font face=楷体 size=4>$$log(R)=log(I)-log(L)$$
 
<font face=楷体 size=4>$$L=F*I$$
